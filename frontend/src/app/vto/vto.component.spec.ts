...
const mockVtoAssetsResponse = {
  male_models: [
    {
      id: 1,
      originalFilename: 'male_model.png',
      presignedUrl:
        'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=',
      asset_type: 'vto_person_male',
    },
  ],
  female_models: [
    {
      id: 2,
      originalFilename: 'female_model.png',
      presignedUrl:
        'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=',
      asset_type: 'vto_person_female',
    },
  ],
  tops: [
    {
  ...
  bottoms: [
    {
      id: 4,
      originalFilename: 'bottom.png',
      presignedUrl:
        'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=',
      asset_type: 'vto_bottom',
    },
  ],
  dresses: [
    {
      id: 5,
      originalFilename: 'dress.png',
      presignedUrl:
        'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=',
      asset_type: 'vto_dress',
    },
  ],
  shoes: [
    {
      id: 6,
      originalFilename: 'shoe.png',
      presignedUrl:
        'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=',
      asset_type: 'vto_shoe',
    },
...
describe('VtoComponent', () => {
  ...
  beforeEach(async () => {
    ...
    const searchServiceMock = {
      ...
      startVtoGeneration: jasmine
        ...
        .and.returnValue(of(mockVtoJob)),
      clearActiveVtoJob: jasmine.createSpy('clearActiveVtoJob'),
    };

    const sourceAssetServiceMock = {
      uploadAsset: jasmine.createSpy('uploadAsset').and.returnValue(
        of({
          id: 123,
          originalFilename: 'new_asset.png',
          presignedUrl: 'gs://new_asset.png',
    ...
    const workspaceStateServiceMock = {
      getActiveWorkspaceId: jasmine
        ...
        .and.returnValue('test-workspace'),
    };
  ...
  describe('State Management', () => {
    it('should save the current state using VtoStateService', () => {
      ...
      expect(vtoStateService.updateState).toHaveBeenCalledWith(
        jasmine.objectContaining(testState),
      );
    });
    ...
    it('should restore the state from VtoStateService', () => {
      ...
      expect(component.secondFormGroup.get('top')?.value).toEqual(
        testState.top,
      );
  ...
  describe('User Interactions', () => {
    ...
    it('should handle file drop', fakeAsync(() => {
      ...
      tick();
      expect(sourceAssetService.uploadAsset).toHaveBeenCalledWith(
        file,
        jasmine.any(Object),
      );
    ...
    it('should handle error on file drop', fakeAsync(() => {
      (sourceAssetService.uploadAsset as jasmine.Spy).and.returnValue(
    ...
    it('should call startVtoGeneration on tryOn', () => {
      component.firstFormGroup
        .get('model')
        ?.setValue({inputLink: {sourceAssetId: 1}});
      component.secondFormGroup
        .get('top')
        ?.setValue({inputLink: {sourceAssetId: 2}});
      component.tryOn();
    ...
    it('should show error if workspaceId is missing on tryOn', () => {
      (
        workspaceStateService.getActiveWorkspaceId as jasmine.Spy
    ...
    it('should set model from image', () => {
      const testMediaItem: MediaItem = {
        ...
        presignedUrls: ['gs://new_model.png'],
        originalPrompt: '',
        createdAt: '',
        updatedAt: '',
        gcsUris: [],
      ...
      expect(component.firstFormGroup.get('model')?.value.name).toBe(
        'Generated Model',
      );
    });
  ...
  describe('Template Rendering', () => {
    ...
    it('should show error message when job has failed', () => {
      ...
      const errorContainer =
        fixture.nativeElement.querySelector('.failure-container');
    ...
    it('should show the result when job is completed', () => {
      ...
      const completedJob = {
        ...mockVtoJob,
        status: JobStatus.COMPLETED,
        presignedUrls: ['gs://result.png'],
      };
      activeVtoJobSubject.next(completedJob);
      fixture.detectChanges();
      const resultImage =
        fixture.nativeElement.querySelector('app-media-lightbox');
